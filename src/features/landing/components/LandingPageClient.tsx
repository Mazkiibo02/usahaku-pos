          ...
          <div className="md:hidden bg-white/95 border-b border-slate-200 backdrop-blur-md absolute top-full left-0 w-full animate-fadeIn shadow-lg">
            <div className="px-4 pt-2 pb-6 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <Link
                  href="/login"
                  className="flex items-center justify-center gap-2 px-4 py-3 border border-slate-200 rounded-xl text-sm font-bold text-slate-700 hover:bg-slate-55 transition-colors"
                >
                  <LogIn className="w-4 h-4" />
                  Masuk
                </Link>
                            ...
                            <div key={item.product.id} className="flex justify-between items-center text-[9px] bg-slate-50 px-2 py-1 rounded">
                              ...
                              <div className="flex items-center gap-1.5">
                                <button
                                  ...
                                  className="w-3.5 h-3.5 rounded bg-slate-200 hover:bg-slate-300 text-slate-850 font-bold flex items-center justify-center text-[10px] transition-colors"
                                >
                                  -
                                </button>
                  ...
                  {showPhoneReceipt && (
                    <div className="absolute inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 z-40 animate-fadeIn">
                      <div className="bg-white w-full rounded-2xl p-4 shadow-xl text-center space-y-3 border border-slate-100 max-w-[240px] animate-scaleUp">
                        ...
                        <div className="border-t border-b border-dashed border-slate-200 py-2 text-left text-[9px] space-y-1 font-mono text-slate-650">
                          {phoneCart.map((item) => (
      ...
      <section className="py-16 sm:py-24 bg-linear-to-tr from-indigo-900 via-indigo-950 to-slate-950 text-white relative overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <p className="text-base sm:text-lg text-slate-350 max-w-xl mx-auto mb-10 leading-relaxed">
            Bergabunglah dengan ratusan pemilik toko di Indonesia yang telah beralih to Usahaku POS. Mudah dioperasikan, aman, dan tanpa biaya bulanan tersembunyi.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              href="https://wa.me/6285117821129?text=Halo%20tim%20Usahaku%20POS,%20saya%20ingin%20dibantu%20mendaftarkan%20toko%2520saya"
              target="_blank"
              rel="noopener noreferrer"
